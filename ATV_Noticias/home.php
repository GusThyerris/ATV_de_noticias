...
<body>
    <header class="topbar">
        ...
        <div class="ctn_topic">
            <div class="topic">
                <p class="text_topic">Esporte</p>
            </div>
            <div class="topic">
                <p class="text_topic">Culinária</p>
            </div>
            <div class="topic">
                <p class="text_topic">Entretenimento</p>
            </div>
            <div class="topic">
                <p class="text_topic">Jogos</p>
            </div>
        </div>
    </header>

    <section class="ctn_noticias">
        <div class="noticia_1"></div>
        <div class="noticia_2"></div>
        <div class="noticia_3"></div>
    </section>

    <footer class="bottombar">
        <div class="ctn_text_bottom">
            <p class="text_bottom">nos acompanhe nas redes sociais...</p>
        </div>
        <div class="ctn_circles">
            <div class="circles youtube">
                <svg fill="#ffffff" height="35px" width="35px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-271 311.2 256 179.8" xml:space="preserve" stroke="#ffffff">
            ...
            <div class="circles facebook">
                <svg fill="#ffffff" height="50px" width="50px" version="1.1" id="Layer_2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-337 273 123.5 256" xml:space="preserve">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
            ...
            <div class="circles instagram">
                <svg viewBox="0 0 24 24" fill="none" height="35px" width="35px" id="Layer_3" xmlns="http://www.w3.org/2000/svg">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
            ...
            <div class="circles twitter">
                <svg fill="#ffffff" height="35px" width="35px" version="1.1" id="Layer_4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-271 296.6 256.4 208.4" xml:space="preserve">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
            ...
            <div class="circles reddit">
                <svg fill="#ffffff" height="40px" width="40px" version="1.1" id="Layer_5" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-268 289.4 262.6 222.6" xml:space="preserve">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
                        <g>
